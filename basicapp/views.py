...
def userprofile(request, pk):
    ...
    return render(request, 'basicapp/profile.html', context)
...
def loginPage(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            messages.error(request, 'Hater DNE!!!!😢')
        ...
        if user is not None:
            ...
            messages.error(request, 'Hater id or Hater password DNE')
    context = {'page': page}
    return render(request, 'basicapp/login_register.html', context)
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'OOpsie')
    
    
    return render(request, 'basicapp/login_register.html', {'form' : form})
@login_required(login_url='login')
...
def editUser(request, pk):
    return render(request, 'basicapp/edit-user.html')